...
def callback(data):
    ...
    file = open("/home/quantum/catkin_ws/src/qr_navigation/scripts/csv_files/urcstart.csv")
...
led_publisher = rospy.Publisher('status_led',Int32, queue_size=1)
