...
class RotateWhileDetectingAr():
    def __init__(self):
        ...
        rospy.Subscriber("/det", Point, self.ar_detected_callback, queue_size=1) 
        self.pub_detected = rospy.Publisher("ar_detected", Bool, queue_size = 10)
        self.num_turns = 1
    ...
    def calculate_num_turns(self):
        if self.prev_orientation is not None:
            ...
            self.num_turns = self.angle_displaced/(2*math.pi)
