    ...
    def imu_and_gps_data_callback(self, data):
        if self.started:
            if self.first_time:
                ...
                self.current_angle = nav_functions.angle_to_only_possitive_deg(self.current_angle)                
                while True:
                    try:
                        self.read_target()
                        break
    ...
    def main(self):
        while not rospy.is_shutdown():            
            ...
            if self.started and not self.first_time:
                ...
                angle_error = nav_functions.rad2deg(math.atan2( target_vector_minus_robot_vector[1],
